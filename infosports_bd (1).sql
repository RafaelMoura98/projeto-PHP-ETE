...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/11/2024 às 01:08
...
INSERT INTO `categoria_tb` (`id`, `nome`, `data`) VALUES
(1, 'Luta', '2024-11-12 20:23:21'),
(2, 'Fitness', '2024-11-12 20:23:48'),
(3, 'Esportes com Bola', '2024-11-12 20:23:59'),
(4, 'Esportes Radicais', '2024-11-12 20:24:10'),
(5, 'Esportes Aquáticos ', '2024-11-12 20:57:33');
...
(6, 'BOXE', 'Descubra a força interior e a técnica impecável necessárias para se destacar no ringue. Desafie-se a superar seus limites físicos e mentais enquanto aprende os segredos deste esporte de combate emocionante.', 'boxe.jpg', 1, '2024-10-07 20:19:38'),
(7, 'CROSSFIT', 'Entre na arena do crossfit e desafie seu corpo em um treinamento intenso e variado que irá transformar sua força,resistência e condicionamento físico. Supere seus limites e alcance novos patamares de desempenho.', 'crossfit.jpg', 2, '2024-10-07 20:21:46'),
(8, 'ESPORTE NA NEVE', 'Sinta a adrenalina das montanhas cobertas de neve enquanto desliza pelas encostas em esportes como esqui e snowboard. Prepare-se para a emoção de voar sobre a neve e dominar as pistas.', 'esportesNaNeve.jpg', 4, '2024-10-07 20:22:08'),
(9, 'BASQUETE', 'Drible, passe, arremesse! Junte-se ao emocionante mundo do basquete e experimente a empolgação de jogar em equipe, competir em partidas acirradas e fazer cestas incríveis.', 'basquete.jpg', 3, '2024-10-07 20:22:38'),
(10, 'CORRIDA', 'Calce seus tênis e sinta a energia pulsante das corridas. Desafie-se em diferentes distâncias, supere obstáculos e descubra os benefícios incríveis para a saúde e o bem-estar que a corrida proporciona.', 'corrida.jpg', 2, '2024-10-07 20:23:03'),
(11, 'SURF', 'Sinta a liberdade e a conexão com o mar enquanto desliza pelas ondas no surf. Experimente a emoção de pegar a onda perfeita, domine as técnicas e mergulhe no estilo de vida descontraído e vibrante do surf.', 'surf.jpg', 5, '2024-10-07 20:23:23'),
(12, 'TRILHA', 'Aventure-se pelos caminhos menos percorridos e descubra a beleza da natureza enquanto se desafia em trilhas emocionantes. Deixe a rotina para trás e explore novos horizontes ao ar livre.', 'trilha.jpg', 2, '2024-10-07 20:23:45'),
(13, 'TÊNIS', 'Experimente a elegância e a velocidade do tênis, um esporte que combina habilidade, estratégia e agilidade. Jogue com paixão, vença com classe e desfrute da competição saudável em quadra.', 'tenis.jpg', 3, '2024-10-07 20:24:02'),
(14, 'SKATE', 'Descubra a adrenalina e a habilidade essenciais para brilhar no skate. Desafie-se a ultrapassar seus limites físicos e mentais enquanto aprende os segredos deste emocionante esporte sobre rodas. Prepare-se para dominar manobras incríveis e explorar a liberdade de se mover sobre o asfalto.', 'skate.jpg', 4, '2024-10-09 21:02:02'),
(15, 'BIKE', 'Descubra a emoção pura e a conexão com a natureza que o mountain bike proporciona. Desafie-se a dominar trilhas desafiadoras e a enfrentar terrenos acidentados, enquanto aprimora sua técnica e resistência. Sinta a adrenalina ao descer encostas íngremes e superar obstáculos, testando seus limites físicos e mentais. O mountain bike é mais do que um esporte; é uma jornada que revela a força interior e a habilidade necessária para se destacar na aventura sobre duas rodas.', 'bicicletas.jpg', 4, '2024-11-01 19:59:56'),
(16, 'NATAÇÃO', 'Descubra a emoção pura e a conexão com a natureza que o mountain bike proporciona. Desafie-se a dominar trilhas desafiadoras e a enfrentar terrenos acidentados, enquanto aprimora sua técnica e resistência. Sinta a adrenalina ao descer encostas íngremes e superar obstáculos, testando seus limites físicos e mentais. O mountain bike é mais do que um esporte; é uma jornada que revela a força interior e a habilidade necessária para se destacar na aventura sobre duas rodas.', 'natacao.jpg', 5, '2024-11-01 20:02:40'),
(17, 'CALISTENIA', 'Explore a potência do seu corpo com a calistenia, um treino que transforma o peso corporal em uma ferramenta de força e flexibilidade. Descubra a disciplina e a técnica necessárias para dominar movimentos desafiadores, como flexões, barras e agachamentos. A calistenia não só desenvolve a musculatura, mas também aprimora a coordenação e o equilíbrio, proporcionando um treino completo e funcional. Desafie-se a superar seus limites e a alcançar novas conquistas, enquanto se conecta com o seu corpo de maneira única. Este esporte acessível e dinâmico é perfeito para quem busca um estilo de vida saudável e ativo, sem a necessidade de equipamentos sofisticados.', 'roupas.jpg', 2, '2024-11-01 20:03:36'),
(21, 'CAPOEIRA', 'Descubra o poder da capoeira, uma arte marcial única que combina força, flexibilidade e musicalidade em um espetáculo de técnica e resistência. Envolva-se na tradição e cultura brasileiras ao dominar movimentos fluidos e estratégicos, desafiando seus limites físicos e mentais. Em cada gingado e acrobacia, sinta a harmonia entre corpo e mente enquanto explora o ritmo do berimbau, a camaradagem do jogo e a autodefesa disfarçada de dança. Na capoeira, cada movimento é uma expressão de liberdade, uma celebração da história e uma chance de superar-se.', 'capoeira.jpg', 1, '2024-11-01 20:37:45'),
(22, 'PARKOUR', 'Explore o mundo ao seu redor de uma maneira totalmente nova com o parkour, uma disciplina que une agilidade, força e criatividade. Desafie-se a superar obstáculos urbanos e naturais com movimentos precisos, saltos ousados e aterrissagens controladas. No parkour, cada parede, corrimão ou estrutura se transforma em uma oportunidade para explorar suas habilidades, testar seus limites físicos e aprimorar seu controle mental. Mais que um esporte, o parkour é uma filosofia de adaptação e liberdade, que leva você a se mover com confiança e a ver o ambiente de forma dinâmica e inovadora.', 'parkour.jpg', 4, '2024-11-01 20:52:46');
